"""
This module contains the S3 blueprint.
"""
...
def create_package_from_files(file_request: Request) -> dict:
    """
    Create a package from the files in the request
    """
    music = file_request.files["music"]
    json = file_request.files["json"]
    image = file_request.files["image"]
